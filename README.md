...
| **[Wolfenstein 3D (cub3d)](https://git@github.com/yahyaeb/Wolfenstein-3D.git)** | A raycasting-based 3D game engine inspired by Wolfenstein 3D, built in C using MiniLibX. Features player movement, wall rendering, textures, and basic game mechanics. **Learned**: *Raycasting algorithms, graphics programming, event handling, and game engine architecture.* | Completed |
